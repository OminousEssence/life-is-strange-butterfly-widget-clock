...
KCM.SimpleKCM {
    ...
    property alias cfg_autoNeonColor: autoNeonColorCheckbox.checked
    property alias cfg_autoTextColor: autoTextColorCheckbox.checked
    property alias cfg_autoSubtitleColor: autoSubtitleColorCheckbox.checked
    property alias cfg_autoTopButterflyColor: autoTopButterflyColorCheckbox.checked
    ...
    property bool cfg_autoNeonColorDefault: false
    property bool cfg_autoTextColorDefault: false
    property bool cfg_autoSubtitleColorDefault: false
    property bool cfg_autoTopButterflyColorDefault: false
    ...
    Kirigami.FormLayout {
        ...
        RowLayout {
            ...
            KQC.ColorButton {
                id: neonColorPicker
                enabled: !autoNeonColorCheckbox.checked
            }
            
            QQC2.CheckBox {
                id: autoNeonColorCheckbox
                text: i18n("Auto (Plasma Theme)")
            }
        }
        ...
        RowLayout {
            ...
            KQC.ColorButton {
                id: textColorPicker
                enabled: !autoTextColorCheckbox.checked
            }
            
            QQC2.CheckBox {
                id: autoTextColorCheckbox
                text: i18n("Auto (Plasma Theme)")
            }
        }
        ...
        RowLayout {
            ...
            KQC.ColorButton {
                ...
                enabled: !autoSubtitleColorCheckbox.checked
            }
            
            QQC2.CheckBox {
                id: autoSubtitleColorCheckbox
                text: i18n("Auto (Plasma Theme)")
            }
        }
        ...
        RowLayout {
            ...
            KQC.ColorButton {
                ...
                enabled: !autoTopButterflyColorCheckbox.checked
            }
            
            QQC2.CheckBox {
                id: autoTopButterflyColorCheckbox
                text: i18n("Auto (Plasma Theme)")
            }
        }
        ...
        QQC2.Button {
            ...
            onClicked: {
                ...
                autoNeonColorCheckbox.checked = cfg_autoNeonColorDefault
                autoTextColorCheckbox.checked = cfg_autoTextColorDefault
                autoSubtitleColorCheckbox.checked = cfg_autoSubtitleColorDefault
                autoTopButterflyColorCheckbox.checked = cfg_autoTopButterflyColorDefault
